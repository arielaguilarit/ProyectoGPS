          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li><a href="../posicionActual/frameActual.php" target="_top">Posicion Actual</a></li>
                <?php
                  if($_SESSION["privilegio"]!=3)
                    echo "<li class='active'><a href='../Reportes/frameReportes.php' target='_top'>Reportes</a></li>";
                  if($_SESSION["privilegio"]!=1)
