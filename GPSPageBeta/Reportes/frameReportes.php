...
<frameset rows="150,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frame src="headerReportes.php" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="arriba" />
  <frameset rows="*" cols="*,304" framespacing="0" frameborder="no" border="0">
   ...
   <frame src="headReportes.php" name="rightFrame" scrolling="auto" noresize="noresize" id="rightFrame" title="derecha" />
                  ...
                  <ul class="nav">
                    <?php
                      if($_SESSION["privilegio"]=="1"){
                        ...
                        echo "<li class='active'><a href='frameReportes.php'>Ruta</a></li>";
